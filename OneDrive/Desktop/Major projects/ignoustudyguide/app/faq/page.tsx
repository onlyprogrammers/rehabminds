  ...
  const faqCategories = [
    {
      ...
      questions: [
        {
          question: "What is Ignou Study Guide?",
          answer:
            "Ignou Study Guide is a comprehensive platform providing study materials, assignments, notes, and academic support services for IGNOU students. We help students excel in their distance learning journey with quality resources and expert guidance.",
        },
        {
