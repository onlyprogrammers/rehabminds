...
import { GraduationCap, Search, Star, TrendingUp, Users } from "lucide-react"
...
export default async function AssignmentsPage() {
  ...
  try {
    const [dbRows, allProgrammes] = await Promise.all([
      getDistinctProgrammes('assignment'),
        ...
        <div className="container mx-auto px-4 py-4 lg:py-8">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-white/20 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-sm font-medium">IGNOU Assignments</span>
            </div>
            <h1 className="text-lg lg:text-2xl font-bold mb-2">Find Your Program Assignments</h1>
            <p className="text-blue-100 text-sm lg:text-xl max-w-2xl mx-auto">
              Download high-quality assignments for all IGNOU programs with detailed solutions and explanations
            </p>
          </div>
      ...
      <div className="bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 py-2">
          <div className="max-w-2xl mx-auto relative">
            ...
            <Input
              placeholder="Search for programs, subjects, or assignment codes..."
      ...
      <div className="container mx-auto px-4 py-4 lg:py-12">
        ...
        <div className="mb-8">
          <div className="text-center mb-4">
            ...
            <p className="text-gray-600 text-lg">Most downloaded assignments by our students</p>
          </div>

          <div className="grid grid-cols-4 md:grid-cols-5 lg:grid-cols-5 gap-3 md:gap-6">
            {popularPrograms.map((program, idx) => (
              <Link key={program.code} href={`/assignments/${program.slug}`}>
                  ...
                  <CardContent className="p-3 md:p-6 text-center">
                    ...
                    {(program.count ?? 0) > 0 && (
                      <div className="text-xs text-gray-500 flex items-center justify-center gap-1">
                        ...
                        <span>{program.count} assignments</span>
                      </div>
                    )}
                  </CardContent>
                </Card>
        ...
        <div>
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Browse assignments for all IGNOU programs</p>
          </div>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-lg p-6 lg:p-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Why Choose Our Assignments?</h3>
