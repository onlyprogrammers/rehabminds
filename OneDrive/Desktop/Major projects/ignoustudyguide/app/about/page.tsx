    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">About Ignou Study Guide</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Ignou Study Guide was founded in 2014 by a group of IGNOU alumni who understood the challenges faced by distance
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-white/10 border-white/20 text-white">
              <CardContent className="pt-6">
                ...
                <p className="mb-4">
                  "Ignou Study Guide saved my academic career! Their assignments are top-quality and helped me score excellent
