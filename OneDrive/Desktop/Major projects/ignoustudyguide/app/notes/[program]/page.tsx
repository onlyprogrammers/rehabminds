...
export default function ProgramPage({ params }: { params: Promise<{ program: string }> }) {
  ...
  useEffect(() => {
    fetch(`/api/materials/counts?programme=${encodeURIComponent(programName)}&type=notes`)
      .then((r) => r.json())
      .then((data) => {
  ...
  const handleSubjectClick = (semesterId: string, subjectCode: string) => {
    const route = `/notes/${programSlug}/${programSlug}-${semesterId}-${subjectCode.toLowerCase()}`
    router.push(route)
  }
      ...
      <div className="bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 py-4 lg:py-6">
          <div className="flex items-center gap-2 mb-3">
            <Link href="/notes" className="flex items-center gap-1 text-blue-600 hover:text-blue-800 text-sm">
          ...
          <p className="text-sm lg:text-lg text-gray-600">
            Select a semester to view available subjects and notes
          </p>
        </div>
      </div>
                    ...
                    {activeSemester === semester.id && (
                      <div className="px-4 lg:px-6 pb-4 bg-gray-50">
                        <div className="pt-4 border-t border-gray-200">
                          <p className="text-sm text-gray-600 mb-3">Select a subject to view notes:</p>
          ...
          <div className="mt-12 bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-rows-2 lg:grid-cols-4 gap-4 text-center mobflex">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Notes in DB</div>
              </div>
              <div>
